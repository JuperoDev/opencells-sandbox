...
exports.WcLitElementPackageMixin = exports.WcLitElementMixin = void 0;
...
const WcLitElementMixin = subclass => class extends subclass {
  async execute() {
    ...
    this.copyTemplate(`${__dirname}/templates/MyEl.js`, this.destinationPath(`src/${className}.js`)); // write & rename el registration template
...
exports.WcLitElementMixin = WcLitElementMixin;

const WcLitElementPackageMixin = subclass => class extends (0, _index.CommonRepoMixin)(WcLitElementMixin(subclass)) {
  async execute() {
...
exports.WcLitElementPackageMixin = WcLitElementPackageMixin;