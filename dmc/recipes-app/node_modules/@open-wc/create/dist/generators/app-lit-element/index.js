...
exports.AppLitElementMixin = void 0;

var _index = require("../common-repo/index.js");

/* eslint-disable no-console */
const AppLitElementMixin = subclass => class extends (0, _index.CommonRepoMixin)(subclass) {
  async execute() {
    await super.execute();
    const {
      tagName,
    ...
    this.copyTemplate(`${__dirname}/templates/my-app.js`, this.destinationPath(`src//${tagName}.js`));
    this.copyTemplate(`${__dirname}/templates/MyApp.js`, this.destinationPath(`src/${className}.js`));
    ...
    if (this.options._scaffoldFilesFor && this.options._scaffoldFilesFor.includes('demoing')) {
      this.copyTemplate(`${__dirname}/templates/my-app.stories.js`, this.destinationPath(`./stories/${tagName}.stories.js`));
    ...
    if (this.options._scaffoldFilesFor && this.options._scaffoldFilesFor.includes('testing')) {
      this.copyTemplate(`${__dirname}/templates/my-app.test.js`, this.destinationPath(`./test/${tagName}.test.js`));
...
exports.AppLitElementMixin = AppLitElementMixin;