...
var enqueCommand = function(command, parameters) {
...
var Bridge = class {
  ...
  constructor(config2) {
    ...
    this.eventSubscriptions = config2.eventSubscriptions;
    this.skipNavigations = config2.skipNavigations;
    this.postMessageTargetOrigin = config2.postMessageTargetOrigin;
    this.interceptor = config2.interceptor;
    this.mainNode = config2.mainNode;
    this.routes = config2.routes;
    if (!this.mainNode) {
    ...
    if (this.debug) {
      ...
      $bridge = {
        ...
        updateApplicationConfig: (config3, options) => this.updateApplicationConfig(config3, options),
        // router interceptor
...
//# sourceMappingURL=chunk-BDFWG34L.js.map
